...
- Don't give the subagent lengthy unnecessary instructions or constraints, just tell it to use the skill, simple clear plain english, and pass along any specific instructions requested by the user.
