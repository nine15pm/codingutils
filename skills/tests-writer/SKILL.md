...
- Keep tests small, direct, and clean (extremely easy to consume). Use shared helpers or a small test harness for repeated setup, but avoid abstractions that make the test harder to understand.