...
- Keep tests small, clean, and readable. Use shared helpers or a small test harness for repeated setup, but avoid abstractions that make the test harder to understand.